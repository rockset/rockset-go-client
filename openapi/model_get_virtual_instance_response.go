...
// checks if the GetVirtualInstanceResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetVirtualInstanceResponse{}
...
func (o GetVirtualInstanceResponse) ToMap() (map[string]interface{}, error) {
