...
// checks if the CreateWorkspaceResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateWorkspaceResponse{}
...
func (o CreateWorkspaceResponse) ToMap() (map[string]interface{}, error) {
...
func NewNullableCreateWorkspaceResponse(val *CreateWorkspaceResponse) *NullableCreateWorkspaceResponse {
	return &NullableCreateWorkspaceResponse{value: val, isSet: true}
}
