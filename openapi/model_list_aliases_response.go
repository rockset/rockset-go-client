...
// checks if the ListAliasesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListAliasesResponse{}
...
func (o ListAliasesResponse) ToMap() (map[string]interface{}, error) {
