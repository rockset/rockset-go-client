...
// checks if the GetAliasResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAliasResponse{}
...
func (o GetAliasResponse) ToMap() (map[string]interface{}, error) {
