...
// checks if the ListWorkspacesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListWorkspacesResponse{}
...
func (o ListWorkspacesResponse) ToMap() (map[string]interface{}, error) {
