...
// checks if the ResumeVirtualInstanceResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeVirtualInstanceResponse{}
...
func NewResumeVirtualInstanceResponse() *ResumeVirtualInstanceResponse {
	this := ResumeVirtualInstanceResponse{}
	return &this
}
...
func (o ResumeVirtualInstanceResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResumeVirtualInstanceResponse struct {
	value *ResumeVirtualInstanceResponse
	isSet bool
}

func (v NullableResumeVirtualInstanceResponse) Get() *ResumeVirtualInstanceResponse {
	return v.value
}

func (v *NullableResumeVirtualInstanceResponse) Set(val *ResumeVirtualInstanceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeVirtualInstanceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeVirtualInstanceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeVirtualInstanceResponse(val *ResumeVirtualInstanceResponse) *NullableResumeVirtualInstanceResponse {
	return &NullableResumeVirtualInstanceResponse{value: val, isSet: true}
}
