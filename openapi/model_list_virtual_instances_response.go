...
// checks if the ListVirtualInstancesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListVirtualInstancesResponse{}
...
func NewListVirtualInstancesResponse() *ListVirtualInstancesResponse {
	this := ListVirtualInstancesResponse{}
	return &this
}
...
func (o ListVirtualInstancesResponse) ToMap() (map[string]interface{}, error) {
...
type NullableListVirtualInstancesResponse struct {
	value *ListVirtualInstancesResponse
	isSet bool
}
...
func NewNullableListVirtualInstancesResponse(val *ListVirtualInstancesResponse) *NullableListVirtualInstancesResponse {
	return &NullableListVirtualInstancesResponse{value: val, isSet: true}
}
