...
// checks if the UpdateUnsubscribePreferencesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateUnsubscribePreferencesRequest{}
...
func NewUpdateUnsubscribePreferencesRequest() *UpdateUnsubscribePreferencesRequest {
	this := UpdateUnsubscribePreferencesRequest{}
	return &this
}
...
func (o UpdateUnsubscribePreferencesRequest) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateUnsubscribePreferencesRequest struct {
	value *UpdateUnsubscribePreferencesRequest
	isSet bool
}
...
func NewNullableUpdateUnsubscribePreferencesRequest(val *UpdateUnsubscribePreferencesRequest) *NullableUpdateUnsubscribePreferencesRequest {
	return &NullableUpdateUnsubscribePreferencesRequest{value: val, isSet: true}
}
