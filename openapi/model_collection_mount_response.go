...
// checks if the CollectionMountResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionMountResponse{}
...
func (o CollectionMountResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionMountResponse struct {
	value *CollectionMountResponse
	isSet bool
}

func (v NullableCollectionMountResponse) Get() *CollectionMountResponse {
	return v.value
}

func (v *NullableCollectionMountResponse) Set(val *CollectionMountResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionMountResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionMountResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionMountResponse(val *CollectionMountResponse) *NullableCollectionMountResponse {
	return &NullableCollectionMountResponse{value: val, isSet: true}
}
