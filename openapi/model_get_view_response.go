...
// checks if the GetViewResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetViewResponse{}
...
func (o GetViewResponse) ToMap() (map[string]interface{}, error) {
