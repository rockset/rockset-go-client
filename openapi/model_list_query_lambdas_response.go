...
// checks if the ListQueryLambdasResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListQueryLambdasResponse{}
...
func (o ListQueryLambdasResponse) ToMap() (map[string]interface{}, error) {
