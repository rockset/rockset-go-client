...
// checks if the ListQueriesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListQueriesResponse{}
...
func (o ListQueriesResponse) ToMap() (map[string]interface{}, error) {
