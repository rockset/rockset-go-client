...
// checks if the CreateIntegrationResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateIntegrationResponse{}
...
// NewCreateIntegrationResponse instantiates a new CreateIntegrationResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCreateIntegrationResponse() *CreateIntegrationResponse {
	this := CreateIntegrationResponse{}
	return &this
}

// NewCreateIntegrationResponseWithDefaults instantiates a new CreateIntegrationResponse object
...
func (o CreateIntegrationResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCreateIntegrationResponse struct {
	value *CreateIntegrationResponse
	isSet bool
}
...
func NewNullableCreateIntegrationResponse(val *CreateIntegrationResponse) *NullableCreateIntegrationResponse {
	return &NullableCreateIntegrationResponse{value: val, isSet: true}
}
