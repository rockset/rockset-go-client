...
// checks if the DeleteAliasResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteAliasResponse{}
...
func (o DeleteAliasResponse) ToMap() (map[string]interface{}, error) {
...
func NewNullableDeleteAliasResponse(val *DeleteAliasResponse) *NullableDeleteAliasResponse {
	return &NullableDeleteAliasResponse{value: val, isSet: true}
}
