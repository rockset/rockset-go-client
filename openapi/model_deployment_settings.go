...
type DeploymentSettings struct {
	DefaultQueryVi *VirtualInstanceRrn `json:"default_query_vi,omitempty"`
}
...
// SetDefaultQueryVi gets a reference to the given VirtualInstanceRrn and assigns it to the DefaultQueryVi field.
