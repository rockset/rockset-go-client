...
// checks if the CreateAliasResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAliasResponse{}
...
func (o CreateAliasResponse) ToMap() (map[string]interface{}, error) {
...
func NewNullableCreateAliasResponse(val *CreateAliasResponse) *NullableCreateAliasResponse {
	return &NullableCreateAliasResponse{value: val, isSet: true}
}
