...
func (r ApiListAliasesForCollectionRequest) Execute() (ListAliasesResponse, *_nethttp.Response, error) {
	return r.ApiService.ListAliasesForCollectionExecute(r)
}
 ...
 * @return ListAliasesResponse
 */
func (a *CollectionsApiService) ListAliasesForCollectionExecute(r ApiListAliasesForCollectionRequest) (ListAliasesResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CollectionsApiService.ListAliasesForCollection")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/orgs/self/ws/{workspace}/collections/{collection}/aliases"
	localVarPath = strings.Replace(localVarPath, "{"+"workspace"+"}", _neturl.PathEscape(parameterToString(r.workspace, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"collection"+"}", _neturl.PathEscape(parameterToString(r.collection, "")), -1)
...
func (r ApiListQueryLambdasInCollectionRequest) Execute() (ListQueryLambdaVersionsResponse, *_nethttp.Response, error) {
	return r.ApiService.ListQueryLambdasInCollectionExecute(r)
}
 ...
 * @return ListQueryLambdaVersionsResponse
 */
func (a *CollectionsApiService) ListQueryLambdasInCollectionExecute(r ApiListQueryLambdasInCollectionRequest) (ListQueryLambdaVersionsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CollectionsApiService.ListQueryLambdasInCollection")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/orgs/self/ws/{workspace}/collections/{collection}/lambdas"
	localVarPath = strings.Replace(localVarPath, "{"+"workspace"+"}", _neturl.PathEscape(parameterToString(r.workspace, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"collection"+"}", _neturl.PathEscape(parameterToString(r.collection, "")), -1)
