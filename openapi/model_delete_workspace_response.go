...
// checks if the DeleteWorkspaceResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteWorkspaceResponse{}
...
func (o DeleteWorkspaceResponse) ToMap() (map[string]interface{}, error) {
